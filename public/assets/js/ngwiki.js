/*! ngwiki - v0.0.0 - 2014-01-05
* Copyright (c) 2014 takyam <takayuki.yamaguch.m@gmail.com>; Licensed MIT */
...
App.collection.Elements = Backbone.Collection.extend({
  url: 'elements',
...
(function ($, _, Backbone) {
  $(function () {
    var page = new App.view.page.standard();
  });
})(jQuery, _, Backbone);